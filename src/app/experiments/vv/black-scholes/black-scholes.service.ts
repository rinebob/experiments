...
import { BlackScholesInputs, BlackScholesOutput } from '../../../common/option_interfaces';
...
export class BlackScholesService {
  ...
  T = DAYS_IN_A_YEAR;  // T - number of days per year can be calendar or trading but must be consistent
  ...
  getOneOptionPriceWithGreeks(input: BlackScholesInputs) {
    ...
    const output: BlackScholesOutput = {
      callPrice: Number(formatNumber(callPrice, this.locale, this.numberPipeString)),
      callDelta: Number(formatNumber(callDelta, this.locale, this.numberPipeString)),
      callTheta: Number(formatNumber(callTheta, this.locale, this.numberPipeString)),
      putPrice: Number(formatNumber(putPrice, this.locale, this.numberPipeString)),
      putDelta: Number(formatNumber(putDelta, this.locale, this.numberPipeString)),
      putTheta: Number(formatNumber(putTheta, this.locale, this.numberPipeString)),
      gamma: Number(formatNumber(this.calcGamma(input), this.locale, this.numberPipeString)),
      vega: Number(formatNumber(this.calcVega(input), this.locale, this.numberPipeString)),
