...
export const ALL_OPTION_CONFIGS_LIST: OptionSpreadConfigBase[] = [
    ATM_LONG_STRADDLE,
    IRON_CONDOR,
    VERTICAL_CALL_DEBIT_SPREAD,
    VERTICAL_CALL_CREDIT_SPREAD,
    TWENTY_DELTA_SHORT_STRANGLE,
    VERTICAL_PUT_DEBIT_SPREAD,
    VERTICAL_PUT_CREDIT_SPREAD,
    ATM_CALL_CALENDAR_SPREAD,
    ATM_PUT_CALENDAR_SPREAD,
  ];
